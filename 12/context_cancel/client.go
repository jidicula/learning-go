...
// callBoth creates a cancellable context and cancellation function from passed-in context.
...
// callServer is a simple client creating requests with a cancellable context.
